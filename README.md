...
Strong CTA guard отклоняет слабые призывы. Growth-пост должен содержать 300–700 символов,
2–4 коротких абзаца и пройти полную validation; слабый, короткий или оборванный текст
заменяется проверенным viral fallback. Автопостинг выбирает лучший
...
Публичные Threads-посты никогда не содержат WhatsApp-ссылок: WhatsApp используется только
Sales DM Agent после определения горячего лида. Если задан `PUBLIC_TELEGRAM_BOT_LINK`,
часть постов может вести в Telegram, но CTA чередуются с призывами написать в личку и
заказать разбор Direct/WhatsApp.
